...
import { buildImagePayload } from "./product-images-manager/utils";
...
export function ProductForm({
  ...
  const handleFormSubmit = (values: CreateProductFormValues) => {
    ...
    const { images: galleryImages, imageMetas: galleryMetas } =
      buildImagePayload(values.gallery || []);
    galleryImages.forEach((f) => values.images.push(f));
    galleryMetas.forEach((m) => values.imageMetas.push(m));
